...
def pddSearch():
    ...
    depth = 4
    start_url = "https://mobile.pinduoduo.com/search_result.html?search_key=" + goods + "&search_type=goods&source=index&options=3&search_met_track=manual&refer_page_el_sn=99884&refer_page_name=login&refer_page_id=10169_1641394734241_t1v7h7emz7&refer_page_sn=10169"
    infoList = []
    num = 300
